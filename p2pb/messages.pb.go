...
func (x *TestMessage) GetSender() string {
	if x != nil {
		return x.Sender
	}
	return ""
...
func (x *TestMessage) GetReceiver() string {
	if x != nil {
		return x.Receiver
	}
	return ""
...
type ConnMessage struct {
	...
	Offset int64 `protobuf:"varint,2,opt,name=offset,proto3" json:"offset,omitempty"` // To avoid sending a null message in case sender = 0
}
...
func (x *ConnMessage) GetSender() int64 {
	if x != nil {
		return x.Sender
	}
	return 0
...
func (x *ConnMessage) GetOffset() int64 {
	if x != nil {
		return x.Offset
	}
	return 0
...
func (x *DiscoveryMessage) GetSender() int32 {
	if x != nil {
		return x.Sender
	}
	return 0
...
func (x *DiscoveryMessage) GetAttempt() int32 {
	if x != nil {
		return x.Attempt
	}
	return 0
...
var file_messages_proto_rawDesc = []byte{
	...
	0x12, 0x04, 0x70, 0x32, 0x70, 0x62, 0x22, 0x55, 0x0a, 0x0b, 0x74, 0x65, 0x73, 0x74, 0x4d, 0x65,
	...
	,
}
...
var file_messages_proto_goTypes = []interface{}{
	(*TestMessage)(nil),      // 0: p2pb.testMessage
	(*ConnMessage)(nil),      // 1: p2pb.connMessage
	(*DiscoveryMessage)(nil), // 2: p2pb.discoveryMessage
}
